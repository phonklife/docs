...
<ParamField body="model" type="string" default="chirp-v3-5">
  Compatibility field for OpenAI-style clients. Use `chirp-v3-5` unless you have verified your deployment supports a different generation model through this endpoint.
</ParamField>
